...
{\large \today}\\Wordcount: 7.675\\[4cm] % Date
...
By matching information on firm level from two sources this thesis provides insights into the effects of government support during the COVID-19 pandemic in Germany. 
...
\begin{declaration}
	...
	\noindent DATE: 02.05.2023\\
	%\rule[0.5em]{25em}{0.5pt} % This prints a line for the signature
	 
	\noindent NAME: Marco Schildt\\
